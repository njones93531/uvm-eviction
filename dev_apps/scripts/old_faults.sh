...
MODULE_DIR=../../drivers/x86_64-555.42.02/faults/${srcv}/
...
sudo insmod ${MODULE_PATH} uvm_perf_prefetch_enable=0 #uvm_perf_fault_coalesce=0 #uvm_perf_fault_batch_count=1
