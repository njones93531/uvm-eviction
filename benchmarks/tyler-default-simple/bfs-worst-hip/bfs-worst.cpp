...
int main(int argc, char* argv[]){
	...
	int count;
	hipErrchk(hipGetDeviceCount(&count));
...
#endif
	printf("Start address of edgeList:\t%p\n", &(edgeList[0]));
    	printf("Start address of vertexList:\t%p\n", &(vertexList[0]));
    	printf("Start address of label:\t%p\n", &(label[0]));
    	printf("Start address of changed:\t%p\n", &(changed[0]));

	printf("Size of edgeList:\t%p\n", (float)(2 * edges * sizeof(uint64_t)) / (1024. * 1024. * 1024.));
    	printf("Size of vertexList:\t%p\n", (float)(vertices * sizeof(uint64_t)) / (1024. * 1024. * 1024.));
    	printf("Size of label:\t%p\n", (float)(vertices * sizeof(uint64_t)) / (1024. * 1024. * 1024.));
