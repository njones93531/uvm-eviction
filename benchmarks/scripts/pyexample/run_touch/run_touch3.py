...
def get_experiment():
    ...
    #psize = 4096*2
    benchmark_args = []
    benchmark_arg_desc="touch2m-3"
    kernel_version = "x86_64-460.27.04"
    kernel_variant = "ac-tracking-full"
    #kernel_variant = ["batchd", "batchd-asyncunmap"]
    kernel_args = {"uvm_perf_access_counter_mimc_migration_enable": 1,"uvm_perf_access_counter_momc_migration_enable": 1,"uvm_perf_access_counter_granularity": "2m", "uvm_perf_access_counter_threshold": 13}
