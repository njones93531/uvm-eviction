...
kernel_arg_dict={"uvm_perf_access_counter_batch_count": "", "uvm_perf_access_counter_granularity": "gran", "uvm_perf_access_counter_threshold": "thold", "uvm_perf_access_counter_mimc_migration_enable": "mimc", "uvm_perf_access_counter_momc_migration_enable": "momc"}
...
class Experiment:
    ...
    def run(self, clear=False):
        ...
        p = subprocess.Popen(["taskset", "-c", "4,5", 'nvprof', '--profile-api-trace', 'none',  '--csv│
            ', './sweep', f'./{self.benchmark_exe}'] + self.benchmark_args, stdout=subprocess.PIPE)
