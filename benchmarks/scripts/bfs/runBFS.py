...
def get_cublas_experiments():
    ...
    #psizes_restricted = [10000, 30000, 50000]
    ...
    policies = ["mmmmmmmm","pppppppp","llllllll"]
    psizes = [100000000,200000000,300000000,400000000]
    benchmark_args = [[["0",str(psize), str(psize),"-p", policy] for policy in policies] for psize in psizes]
    ...
    benchmark = "bfs"
    benchmark_exe = "main"
    bdir_base = "/home/najones/uvm-eviction/benchmarks/UVMBench/bfs"
