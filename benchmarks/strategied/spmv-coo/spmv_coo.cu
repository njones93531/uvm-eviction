...
int main(int argc, char *argv[]) {
    ...
    AccessPolicy acp;
    acp.setAllocationPolicy((void**)(void **)&h_values, nnz * sizeof(float), cudaMemAttachGlobal), 0, argc, argv;
    acp.setAllocationPolicy((void**)(void **)&h_col_indices, nnz * sizeof(int), cudaMemAttachGlobal), 0, argc, argv;
    acp.setAllocationPolicy((void**)(void **)&h_row_indices, nnz * sizeof(int), cudaMemAttachGlobal), 0, argc, argv;
    acp.setAllocationPolicy((void**)(void **)&h_x, N * sizeof(float), cudaMemAttachGlobal), 0, argc, argv;
    acp.setAllocationPolicy((void**)(void **)&h_y, N * sizeof(float), cudaMemAttachGlobal), 0, argc, argv;
