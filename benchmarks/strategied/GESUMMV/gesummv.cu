...
int main(int argc, char *argv[])
{
	...
	acp.setAllocationPolicy((void**)&B_gpu, sizeof(DATA_TYPE) * N * N, 1, argc, argv);
	acp.setAllocationPolicy((void**)&x_gpu, sizeof(DATA_TYPE) * N, 2, argc, argv);
	acp.setAllocationPolicy((void**)&y_gpu, sizeof(DATA_TYPE) * N, 3, argc, argv);
	acp.setAllocationPolicy((void**)&tmp_gpu, sizeof(DATA_TYPE) * N, 4, argc, argv);
